  ...
  function renderReelCard(index) {
    ...
    if (msg.reactions) {
      for (const [emoji, count] of Object.entries(msg.reactions)) {
        ...
        reelReactionsHTML += `<button class="reel-act-btn reel-reaction-pill ${isMyVote ? 'active' : ''}" style="width:auto; padding:0 10px; gap:4px;" onclick="handleReaction('${msg.id}', '${emoji}')">${emoji} <span style="font-size:12px;">${count}</span></button>`;
      }
    }
      ...
      <div class="reel-actions-bar">
        <div class="reel-action-group">
          ...
          <div class="emoji-picker-container">
            <button class="reel-act-btn" onclick="togglePicker('${msg.id}')" title="Реакции">
              <svg viewBox="0 0 24 24" width="19" height="19" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M8 14s1.5 2 4 2 4-2 4-2"></path><line x1="9" y1="9" x2="9.01" y2="9"></line><line x1="15" y1="9" x2="15.01" y2="9"></line></svg>
            </button>
